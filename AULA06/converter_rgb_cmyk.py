# Importamos o módulo Image da biblioteca Pillow
...
def criar_imagem_rgb(largura, altura, cor_rgb, nome_arquivo):
    ...
    # Parâmetros: Modo de cor, (Largura, Altura), Tupla com a Cor.
...
def criar_imagem_cmyk(largura, altura, cor_cmyk, nome_arquivo):
    ...
    """
    # Alocamos a matriz agora no modo CMYK. A tupla exige 4 valores (0 a 255)

    imagem = Image.new("CMYK", (largura, altura), cor_cmyk)
    
    # Ao salvar arquivos CMYK, devemos usar formatos que suportem esse espaço nativamente,
...
def rgb_para_cmyk(r, g, b):
    # Condição de contorno para o preto absoluto, evitar erro de dividir por zero
...
if __name__ == "__main__":
    ...
    criar_imagem_cmyk(LARGURA, ALTURA, cor_amarelo_cmyk_int, "cor_cmyk")
