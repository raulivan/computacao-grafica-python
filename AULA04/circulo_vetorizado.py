def main():
    ...
    # Observe que as propriedades matemáticas continuam 
    # sendo exatamente as mesmas!
    largura_tela = 300
    altura_tela = 300
    centro_x = 150
    centro_y = 150
    ...
    # Observe que não varremos uma grade.
    # Nós escrevemos uma "formular" (XML/SVG) 
    # que os navegadores ou softwares de CAD/Design conseguem ler.
    codigo_vetorial_svg = f"""
        <svg width="{largura_tela}" height="{altura_tela}" 
            xmlns="http://www.w3.org/2000/svg">
            <rect width="100%" height="100%" fill="white" />                      
            <circle cx="{centro_x}" cy="{centro_y}" r="{raio}" 
    ...
    print("Só abrir este arquivo diretamente no navegador!")
