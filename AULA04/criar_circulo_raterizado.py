...
def main():
    ...
    # aqui to defiinindo apenas o quadrado 
    # onde o círculo pode existir.
    x_min = centro_x - raio
    x_max = centro_x + raio
    y_min = centro_y - raio
    y_max = centro_y + raio
    ...
    for x in range(x_min, x_max + 1):
        for y in range(y_min, y_max + 1):
            ...
            # Se a distância do pixel (x,y) até o centro for menor 
            # ou igual ao raio
            if distancia_quadrada <= raio_quadrado:
                # O pixel pertence ao círculo! Pinta de vermelho.
                img.putpixel((x, y), (255, 0, 0))

    # Salva a imagem na pasta de execução do script
